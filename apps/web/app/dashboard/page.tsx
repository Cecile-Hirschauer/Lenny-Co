...
ChildrenIcon.displayName = 'ChildrenIcon';
...
// ============================================
// MOCK DATA (extracted outside component)
// ============================================
...
export default function DashboardPage() {
  // Navigation items pour la sidebar desktop (memoized)
  ...
  // Navigation items pour le bottom nav mobile (memoized)
    ...
    <>
      ...
      <section className={styles.section}>
        <div className={styles.profileCard}>
          <Avatar src={CHILD_PROFILE.avatarUrl} alt={CHILD_PROFILE.name} size="large" />
          <div className={styles.profileInfo}>
            <span className={styles.profileName}>{CHILD_PROFILE.name}</span>
            <div className={styles.onlineStatus}>
              <span className={styles.onlineDot} />
              En ligne
            </div>
            <Tag label={`Niveau ${CHILD_PROFILE.level}`} variant="primary" />
          </div>
        </div>
      </section>
